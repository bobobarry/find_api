...
class UserController extends BaseController
{
    ...
    {
        //$this->authorize('view', User::class);
        return $this->sendResponse(User::whereIn('email', ['tambapaulsossouadouno@gmail.com','dialloamie162@gmail.com','cecilebalamou15@gmail.com'])->get(), "data fetched successfully");
    }
}
